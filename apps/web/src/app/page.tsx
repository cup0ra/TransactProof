        ...
        <section className="py-16 sm:py-20 lg:py-24 relative bg-white dark:bg-black text-center transition-colors duration-300">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="w-16 sm:w-20 lg:w-24 h-px bg-orange-500 mx-auto mb-8 sm:mb-10 lg:mb-12"></div>
              <Link href="/generate" className="group relative inline-flex items-center justify-center overflow-hidden px-8 sm:px-12 lg:px-16 py-4 sm:py-5 text-base sm:text-lg font-light text-white dark:text-black bg-orange-400 rounded-lg hover:bg-orange-500 hover:text-white dark:hover:text-black transition-all duration-300" style={{ fontFamily: "'Clash Display', system-ui, sans-serif" }}>
              <span className="relative z-10">Generate Your First Receipt</span>
              <div className="absolute inset-0 rounded-lg bg-orange-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
            </Link>
          </div>
        </section>
    </>
