    ...
    >
      ...
      >
        <div className="mb-4 flex items-start justify-between gap-4">
          ...
          <button
            type="button"
            className="rounded-2xl border border-gray-300/70 dark:border-gray-700 px-2.5 py-1 text-xs text-gray-600 dark:text-gray-300 hover:text-orange-400 hover:border-orange-400 dark:hover:text-orange-400 dark:hover:text-orange-400 dark:hover:border-orange-400 transition-colors"
